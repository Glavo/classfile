...
final class VerificationBytecodes {
    ...
    static {
        def(ClassFile.NOP, "nop", "b", null, VerificationSignature.BasicType.T_VOID, 0);
        def(ClassFile.ACONST_NULL, "aconst_null", "b", null, VerificationSignature.BasicType.T_OBJECT, 1);
        def(ClassFile.ICONST_M1, "iconst_m1", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ICONST_0, "iconst_0", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ICONST_1, "iconst_1", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ICONST_2, "iconst_2", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ICONST_3, "iconst_3", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ICONST_4, "iconst_4", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ICONST_5, "iconst_5", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.LCONST_0, "lconst_0", "b", null, VerificationSignature.BasicType.T_LONG, 2);
        def(ClassFile.LCONST_1, "lconst_1", "b", null, VerificationSignature.BasicType.T_LONG, 2);
        def(ClassFile.FCONST_0, "fconst_0", "b", null, VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.FCONST_1, "fconst_1", "b", null, VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.FCONST_2, "fconst_2", "b", null, VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.DCONST_0, "dconst_0", "b", null, VerificationSignature.BasicType.T_DOUBLE, 2);
        def(ClassFile.DCONST_1, "dconst_1", "b", null, VerificationSignature.BasicType.T_DOUBLE, 2);
        def(ClassFile.BIPUSH, "bipush", "bc", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.SIPUSH, "sipush", "bcc", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.LDC, "ldc", "bk", null, VerificationSignature.BasicType.T_ILLEGAL, 1);
        def(ClassFile.LDC_W, "ldc_w", "bkk", null, VerificationSignature.BasicType.T_ILLEGAL, 1);
        def(ClassFile.LDC2_W, "ldc2_w", "bkk", null, VerificationSignature.BasicType.T_ILLEGAL, 2);
        def(ClassFile.ILOAD, "iload", "bi", "wbii", VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.LLOAD, "lload", "bi", "wbii", VerificationSignature.BasicType.T_LONG, 2);
        def(ClassFile.FLOAD, "fload", "bi", "wbii", VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.DLOAD, "dload", "bi", "wbii", VerificationSignature.BasicType.T_DOUBLE, 2);
        def(ClassFile.ALOAD, "aload", "bi", "wbii", VerificationSignature.BasicType.T_OBJECT, 1);
        def(ClassFile.ILOAD_0, "iload_0", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ILOAD_1, "iload_1", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ILOAD_2, "iload_2", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.ILOAD_3, "iload_3", "b", null, VerificationSignature.BasicType.T_INT, 1);
        def(ClassFile.LLOAD_0, "lload_0", "b", null, VerificationSignature.BasicType.T_LONG, 2);
        def(ClassFile.LLOAD_1, "lload_1", "b", null, VerificationSignature.BasicType.T_LONG, 2);
        def(ClassFile.LLOAD_2, "lload_2", "b", null, VerificationSignature.BasicType.T_LONG, 2);
        def(ClassFile.LLOAD_3, "lload_3", "b", null, VerificationSignature.BasicType.T_LONG, 2);
        def(ClassFile.FLOAD_0, "fload_0", "b", null, VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.FLOAD_1, "fload_1", "b", null, VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.FLOAD_2, "fload_2", "b", null, VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.FLOAD_3, "fload_3", "b", null, VerificationSignature.BasicType.T_FLOAT, 1);
        def(ClassFile.DLOAD_0, "dload_0", "b", null, VerificationSignature.BasicType.T_DOUBLE, 2);
        def(ClassFile.DLOAD_1, "dload_1", "b", null, VerificationSignature.BasicType.T_DOUBLE, 2);
        def(ClassFile.DLOAD_2, "dload_2", "b", null, VerificationSignature.BasicType.T_DOUBLE, 2);
        def(ClassFile.DLOAD_3, "dload_3", "b", null, VerificationSignature.BasicType.T_DOUBLE, 2);
        def(ClassFile.ALOAD_0, "aload_0", "b", null, VerificationSignature.BasicType.T_OBJECT, 1);
        def(ClassFile.ALOAD_1, "aload_1", "b", null, VerificationSignature.BasicType.T_OBJECT, 1);
        def(ClassFile.ALOAD_2, "aload_2", "b", null, VerificationSignature.BasicType.T_OBJECT, 1);
        def(ClassFile.ALOAD_3, "aload_3", "b", null, VerificationSignature.BasicType.T_OBJECT, 1);
        def(ClassFile.IALOAD, "iaload", "b", null, VerificationSignature.BasicType.T_INT, -1);
        def(ClassFile.LALOAD, "laload", "b", null, VerificationSignature.BasicType.T_LONG, 0);
        def(ClassFile.FALOAD, "faload", "b", null, VerificationSignature.BasicType.T_FLOAT, -1);
        def(ClassFile.DALOAD, "daload", "b", null, VerificationSignature.BasicType.T_DOUBLE, 0);
        def(ClassFile.AALOAD, "aaload", "b", null, VerificationSignature.BasicType.T_OBJECT, -1);
        def(ClassFile.BALOAD, "baload", "b", null, VerificationSignature.BasicType.T_INT, -1);
        def(ClassFile.CALOAD, "caload", "b", null, VerificationSignature.BasicType.T_INT, -1);
        def(ClassFile.SALOAD, "saload", "b", null, VerificationSignature.BasicType.T_INT, -1);
        def(ClassFile.ISTORE, "istore", "bi", "wbii", VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.LSTORE, "lstore", "bi", "wbii", VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.FSTORE, "fstore", "bi", "wbii", VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.DSTORE, "dstore", "bi", "wbii", VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.ASTORE, "astore", "bi", "wbii", VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.ISTORE_0, "istore_0", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.ISTORE_1, "istore_1", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.ISTORE_2, "istore_2", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.ISTORE_3, "istore_3", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.LSTORE_0, "lstore_0", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.LSTORE_1, "lstore_1", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.LSTORE_2, "lstore_2", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.LSTORE_3, "lstore_3", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.FSTORE_0, "fstore_0", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.FSTORE_1, "fstore_1", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.FSTORE_2, "fstore_2", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.FSTORE_3, "fstore_3", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.DSTORE_0, "dstore_0", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.DSTORE_1, "dstore_1", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.DSTORE_2, "dstore_2", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.DSTORE_3, "dstore_3", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.ASTORE_0, "astore_0", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.ASTORE_1, "astore_1", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.ASTORE_2, "astore_2", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.ASTORE_3, "astore_3", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.IASTORE, "iastore", "b", null, VerificationSignature.BasicType.T_VOID, -3);
        def(ClassFile.LASTORE, "lastore", "b", null, VerificationSignature.BasicType.T_VOID, -4);
        def(ClassFile.FASTORE, "fastore", "b", null, VerificationSignature.BasicType.T_VOID, -3);
        def(ClassFile.DASTORE, "dastore", "b", null, VerificationSignature.BasicType.T_VOID, -4);
        def(ClassFile.AASTORE, "aastore", "b", null, VerificationSignature.BasicType.T_VOID, -3);
        def(ClassFile.BASTORE, "bastore", "b", null, VerificationSignature.BasicType.T_VOID, -3);
        def(ClassFile.CASTORE, "castore", "b", null, VerificationSignature.BasicType.T_VOID, -3);
        def(ClassFile.SASTORE, "sastore", "b", null, VerificationSignature.BasicType.T_VOID, -3);
        def(ClassFile.POP, "pop", "b", null, VerificationSignature.BasicType.T_VOID, -1);
        def(ClassFile.POP2, "pop2", "b", null, VerificationSignature.BasicType.T_VOID, -2);
        def(ClassFile.DUP, "dup", "b", null, VerificationSignature.BasicType.T_VOID, 1);
        def(ClassFile.DUP_X1, "dup_x1", "b", null, VerificationSignature.BasicType.T_VOID, 1);
        def(ClassFile.DUP_X2, "dup_x2", "b", null, VerificationSignature.BasicType.T_VOID, 1);
        def(ClassFile.DUP2, "dup2", "b", null, VerificationSignature.BasicType.T_VOID, 2);
        def(ClassFile.DUP2_X1, "dup2_x1", "b", null, VerificationSignature.BasicType.T_VOID, 2);
        def(ClassFile.DUP2_X2, "dup2_x2", "b", null, VerificationSignature.BasicType.T_VOID, 2);
        def(ClassFile.SWAP, "swap", "b", null, VerificationSignature.BasicType.T_VOID, 0);
        def(ClassFile.IADD, "iadd", "b", null, VerificationSignature.BasicType.T_INT, -1);
        def(ClassFile.LADD, "ladd", "b", null, VerificationSignature.BasicType.T_LONG, -2);
        def(ClassFile.FADD, "fadd", "b", null, VerificationSignature.BasicType.T_FLOAT, -1);
        def(ClassFile.DADD, "dadd", "b", null, VerificationSignature.BasicType.T_DOUBLE, -2);
        def(ClassFile.ISUB, "isub", "b", null, VerificationSignature.BasicType.T_INT, -1);
        ...
        def(ClassFile.IOR, "ior", "b", null, VerificationSignature.BasicType.T_INT, -1);
        ...
        def(ClassFile.TABLESWITCH, "tableswitch", "", null, VerificationSignature.BasicType.T_VOID, -1); // may have backward branches
        def(ClassFile.LOOKUPSWITCH, "lookupswitch", "", null, VerificationSignature.BasicType.T_VOID, -1); // rewriting in interpreter
        ...
        def(_fast_aload_0, "fast_aload_0", "b", null, VerificationSignature.BasicType.T_OBJECT, 1, ClassFile.ALOAD_0);
        def(_fast_iaccess_0, "fast_iaccess_0", "b_JJ", null, VerificationSignature.BasicType.T_INT, 1, ClassFile.ALOAD_0);
        def(_fast_aaccess_0, "fast_aaccess_0", "b_JJ", null, VerificationSignature.BasicType.T_OBJECT, 1, ClassFile.ALOAD_0);
        def(_fast_faccess_0, "fast_faccess_0", "b_JJ", null, VerificationSignature.BasicType.T_OBJECT, 1, ClassFile.ALOAD_0);
        def(_fast_iload, "fast_iload", "bi", null, VerificationSignature.BasicType.T_INT, 1, ClassFile.ILOAD);
        def(_fast_iload2, "fast_iload2", "bi_i", null, VerificationSignature.BasicType.T_INT, 2, ClassFile.ILOAD);
        def(_fast_icaload, "fast_icaload", "bi_", null, VerificationSignature.BasicType.T_INT, 0, ClassFile.ILOAD);
        ...
        def(_fast_aldc, "fast_aldc", "bj", null, VerificationSignature.BasicType.T_OBJECT, 1, ClassFile.LDC);
        def(_fast_aldc_w, "fast_aldc_w", "bJJ", null, VerificationSignature.BasicType.T_OBJECT, 1, ClassFile.LDC_W);
        ...
        def(_nofast_aload_0, "nofast_aload_0", "b", null, VerificationSignature.BasicType.T_ILLEGAL, 1, ClassFile.ALOAD_0);
        def(_nofast_iload, "nofast_iload", "bi", null, VerificationSignature.BasicType.T_ILLEGAL, 1, ClassFile.ILOAD);
