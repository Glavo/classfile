 ...
 * <p>
 * A {@link org.glavo.classfile.ClassModel} is an immutable description of a class
 * file.  It provides accessor methods to get at class metadata (e.g., {@link
 * org.glavo.classfile.ClassModel#thisClass()}, {@link org.glavo.classfile.ClassModel#flags()}),
 * as well as subordinate classfile entities ({@link org.glavo.classfile.ClassModel#fields()},
 * {@link org.glavo.classfile.ClassModel#attributes()}). A {@link
 * org.glavo.classfile.ClassModel} is inflated lazily; most parts of the classfile are
 ...
 * <p>
 * Methods like {@link org.glavo.classfile.ClassModel#methods} allows us to traverse the class structure
 ...
 * org.glavo.classfile.ClassModel} also provides us with a view of the classfile as a
 ...
 * the {@link org.glavo.classfile.ClassModel#methods()} accessor) or as a linear
 * sequence of <em>elements</em>. (Elements can in turn also be models; a {@link
 * org.glavo.classfile.FieldModel} is also an element of a class.) For each model type
 * (e.g., {@link org.glavo.classfile.MethodModel}), there is a corresponding element
 * type ({@link org.glavo.classfile.MethodElement}).  Models and elements are immutable
 ...
 * pool</em>. {@link org.glavo.classfile.ClassModel} provides a lazily-inflated,
 * read-only view of the constant pool via {@link org.glavo.classfile.ClassModel#constantPool()}.
 * Descriptions of classfile content is often exposed in the form of various
 * subtypes of {@link org.glavo.classfile.constantpool.PoolEntry}, such as {@link
 * org.glavo.classfile.constantpool.ClassEntry} or {@link org.glavo.classfile.constantpool.Utf8Entry}.
 * <p>
 * Constant pool entries are also exposed through models and elements; in the
 * above traversal example, the {@link org.glavo.classfile.instruction.InvokeInstruction}
 ...
 * org.glavo.classfile.attribute.SignatureAttribute} is a {@link
 * org.glavo.classfile.ClassElement}, {@link org.glavo.classfile.MethodElement}, and {@link
 * org.glavo.classfile.FieldElement} since it can appear in all of those places, and is
 ...
 * provides accessors for {@link org.glavo.classfile.attribute.SignatureAttribute#signature()}
 * as well as factories taking {@link org.glavo.classfile.constantpool.Utf8Entry} or
 * {@link java.lang.String}.
 *
 * <h3>Custom attributes</h3>
 * Attributes are converted between their classfile form and their corresponding
 * object form via an {@link org.glavo.classfile.AttributeMapper}.  An {@code
 * AttributeMapper} provides the
 * {@link org.glavo.classfile.AttributeMapper#readAttribute(AttributedElement,
 * ClassReader, int)} method for mapping from the classfile format
 * to an attribute instance, and the
 * {@link org.glavo.classfile.AttributeMapper#writeAttribute(BufWriter,
 ...
 * <p>
 * There are built-in attribute mappers (in {@link org.glavo.classfile.Attributes}) for
 ...
 * org.glavo.classfile.attribute.UnknownAttribute}, which provide access only to the
 ...
 * {@snippet lang="java" class="RootPackageSnippets" region="helloWorld1"}
 * <p>
 ...
 * {@snippet lang="java" class="RootPackageSnippets" region="helloWorld2"}
 * <p>
 ...
 * org.glavo.classfile.CodeBuilder#invokevirtual(java.lang.constant.ClassDesc,
 ...
 * method {@link org.glavo.classfile.constantpool.ClassEntry#asSymbol} returns
 * {@code ClassDesc}.
 * <p>
 ...
 * get an existing {@link org.glavo.classfile.ClassModel}, build a new classfile that
 ...
 * {@snippet lang="java" class="RootPackageSnippets" region="stripDebugMethods3"}
 *
 ...
 * {@snippet lang="java" class="RootPackageSnippets" region="strictTransform1"}
 * {@snippet lang="java" class="RootPackageSnippets" region="strictTransform2"}
 * {@snippet lang="java" class="RootPackageSnippets" region="strictTransform3"}
 * <p>
 ...
 * code transformation:
 * {@snippet lang="java" class="RootPackageSnippets" region="benevolentTransform"}
 *
 ...
 * org.glavo.classfile.constantpool.ClassEntry}.) Factories and builders also
 ...
 * {@link org.glavo.classfile.CodeModel} (which models the {@code Code} attribute
 ...
 * }
 *
 * {@link org.glavo.classfile.CodeModel} is unique in that its elements are <em>ordered</em>.
