...
public class ConstantUtils {
     ...
     * initialization method has this special name, ACC_STATIC flag set,
     * is {@link #MTD_void void} and takes no arguments.
     *
    ...
    private static final Set<String> pointyNames = Set.of(INIT_NAME, CLASS_INIT_NAME);
