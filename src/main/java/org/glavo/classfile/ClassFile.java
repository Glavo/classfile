...
public sealed interface ClassFile
     ...
     * {@snippet lang = java:
     *     import org.glavo.classfile.constantpool.ConstantPoolBuilder;this.build(model.thisClass(), ConstantPoolBuilder.of(model),
     ...
     * This method behaves as if:
     * {@snippet lang = java:
     *     import org.glavo.classfile.constantpool.ConstantPoolBuilder;this.build(newClassName, ConstantPoolBuilder.of(model),
     *                     b -> b.transform(model, transform));
     *}
     *
     * @param model the class model to transform
